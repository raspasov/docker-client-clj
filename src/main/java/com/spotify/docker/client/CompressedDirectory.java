...
class CompressedDirectory implements Closeable {
   ...
   * java.nio.file.Files#createTempFile(String, String, java.nio.file.attribute.FileAttribute[])} method. The returned object is
   * auto-closeable, and upon closing it, the archive file will be deleted.
   *
   * @param directory the directory to compress
   * @return a Path object representing the compressed directory
   * @throws java.io.IOException if the compressed directory could not be created.
   */
