...
package test.java.com.spotify.docker.test;
...
/**
 * The {@link test.java.com.spotify.docker.test.CreateContainer} annotation can be used on any test method to provide the values for
